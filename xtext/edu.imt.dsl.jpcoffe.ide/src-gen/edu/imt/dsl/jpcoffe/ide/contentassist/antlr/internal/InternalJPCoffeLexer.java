...
public class InternalJPCoffeLexer extends Lexer {
    ...
    public final void mRULE_METRIC_UNIT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalJPCoffe.g:1797:18: ( ( 'gr' | 'kg' | 'cl' | 'l' ) )
            // InternalJPCoffe.g:1797:20: ( 'gr' | 'kg' | 'cl' | 'l' )
            {
            // InternalJPCoffe.g:1797:20: ( 'gr' | 'kg' | 'cl' | 'l' )
            int alt1=4;
            switch ( input.LA(1) ) {
    ...
    public final void mRULE_TITLE_LINE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalJPCoffe.g:1799:17: ( ( '-' )+ )
            // InternalJPCoffe.g:1799:19: ( '-' )+
            {
            // InternalJPCoffe.g:1799:19: ( '-' )+
            int cnt2=0;
            loop2:
    ...
    public final void mRULE_NAME() throws RecognitionException {
        try {
            int _type = RULE_NAME;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalJPCoffe.g:1801:11: ( 'A' .. 'Z' ( 'a' .. 'z' | 'A' .. 'Z' | RULE_SPACE )* )
            // InternalJPCoffe.g:1801:13: 'A' .. 'Z' ( 'a' .. 'z' | 'A' .. 'Z' | RULE_SPACE )*
            {
            matchRange('A','Z'); 
            // InternalJPCoffe.g:1801:22: ( 'a' .. 'z' | 'A' .. 'Z' | RULE_SPACE )*
            loop3:
            do {
                int alt3=2;
    ...
    public final void mRULE_NEW_LINE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalJPCoffe.g:1803:15: ( ( '\\n' | '\\r\\n' ) )
            // InternalJPCoffe.g:1803:17: ( '\\n' | '\\r\\n' )
            {
            // InternalJPCoffe.g:1803:17: ( '\\n' | '\\r\\n' )
            int alt4=2;
    ...
    public final void mRULE_SPACE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalJPCoffe.g:1805:12: ( ' ' )
            // InternalJPCoffe.g:1805:14: ' '
            {
            match(' '); 
    ...
    public final void mRULE_TEXT() throws RecognitionException {
        try {
            int _type = RULE_TEXT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalJPCoffe.g:1807:11: ( ( 'a' .. 'z' | 'A' .. 'Z' )+ )
            // InternalJPCoffe.g:1807:13: ( 'a' .. 'z' | 'A' .. 'Z' )+
            {
            // InternalJPCoffe.g:1807:13: ( 'a' .. 'z' | 'A' .. 'Z' )+
            int cnt5=0;
            loop5:
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalJPCoffe.g:1809:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalJPCoffe.g:1809:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalJPCoffe.g:1809:11: ( '^' )?
            int alt6=2;
            ...
            // InternalJPCoffe.g:1809:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalJPCoffe.g:1811:10: ( ( '0' .. '9' )+ )
            // InternalJPCoffe.g:1811:12: ( '0' .. '9' )+
            {
            // InternalJPCoffe.g:1811:12: ( '0' .. '9' )+
            int cnt8=0;
            loop8:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalJPCoffe.g:1813:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalJPCoffe.g:1813:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalJPCoffe.g:1813:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt11=2;
            ...
            switch (alt11) {
                case 1 :
                    // InternalJPCoffe.g:1813:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalJPCoffe.g:1813:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop9:
                    do {
                        int alt9=3;
                    ...
                    break;
                case 2 :
                    // InternalJPCoffe.g:1813:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalJPCoffe.g:1813:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop10:
                    do {
                        int alt10=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalJPCoffe.g:1815:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalJPCoffe.g:1815:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalJPCoffe.g:1815:24: ( options {greedy=false; } : . )*
            loop12:
            do {
                int alt12=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Internal